use familiar_core::models::{Decision, NewDecision};
...
pub trait DecisionRepository {
    fn create_decision(&self, decision: &NewDecision) -> familiar_core::Result<Decision>;
    fn get_decision_by_id(&self, id: i64) -> familiar_core::Result<Option<Decision>>;
    fn list_decisions_by_project(
        &self,
        project_id: i64,
        limit: usize,
    ) -> familiar_core::Result<Vec<Decision>>;
    fn delete_decision(&self, id: i64) -> familiar_core::Result<()>;
}
