use familiar_core::models::{NewSessionRollup, SessionRollup};
...
pub trait SessionRollupRepository {
    ...
    ) -> familiar_core::Result<SessionRollup>;
    fn get_session_rollup_by_id(&self, id: i64) -> familiar_core::Result<Option<SessionRollup>>;
    fn list_session_rollups_by_project(
        &self,
        project_id: i64,
        limit: usize,
    ) -> familiar_core::Result<Vec<SessionRollup>>;
    fn delete_session_rollup(&self, id: i64) -> familiar_core::Result<()>;
}
