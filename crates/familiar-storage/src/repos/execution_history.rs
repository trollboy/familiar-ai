...
impl<'a> ExecutionHistoryRepository<'a> {
    ...
    pub fn insert_running(&self, value: &ExecutionStart) -> familiar_core::Result<()> {
    ...
    pub fn finalize(&self, id: &str, value: &ExecutionFinalization) -> familiar_core::Result<()> {
        let unavailable = json(&value.unavailable_fields)?;
    ...
    pub fn get(&self, id: &str) -> familiar_core::Result<Option<ExecutionRecord>> {
    ...
    pub fn recent(&self, limit: u8) -> familiar_core::Result<Vec<ExecutionRecord>> {
    ...
    pub fn usage(&self) -> familiar_core::Result<UsageSummary> {
...
fn json(v: &BTreeMap<String, String>) -> familiar_core::Result<String> {
...
fn checked(a: u64, b: u64) -> familiar_core::Result<u64> {
    a.checked_add(b)
