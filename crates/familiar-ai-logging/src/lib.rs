...
use familiar_ai_core::config::{LogFormat, LoggingConfig};
...
mod tests {
    use super::*;
    use familiar_ai_core::config::LoggingConfig;
    ...
    // familiar-ai-daemon tests both formats via separate processes.
