use familiar_ai_core::models::{NewProject, Project};
...
pub trait ProjectRepository {
    fn create_project(&self, project: &NewProject) -> familiar_ai_core::Result<Project>;
    fn get_project_by_id(&self, id: i64) -> familiar_ai_core::Result<Option<Project>>;
    fn get_project_by_repo_root(
        &self,
        repo_root: &str,
    ) -> familiar_ai_core::Result<Option<Project>>;
    fn list_active_projects(&self) -> familiar_ai_core::Result<Vec<Project>>;
    fn update_project(&self, project: &Project) -> familiar_ai_core::Result<()>;
    fn delete_project(&self, id: i64) -> familiar_ai_core::Result<()>;
}
