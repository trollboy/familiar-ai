...
const MIGRATIONS: &[Migration] = &[
    ...
    Migration {
        version: 54,
        sql: include_str!("../migrations/054_cost_reconciliation.sql"),
    },
    Migration {
        version: 55,
        sql: include_str!("../migrations/055_agent_runtime.sql"),
    },
    Migration {
        version: 56,
        sql: include_str!("../migrations/056_substance_keyed_waivers.sql"),
    },
    Migration {
        version: 57,
        sql: include_str!("../migrations/057_token_discipline.sql"),
    },
    Migration {
        version: 58,
        sql: include_str!("../migrations/058_batch_reviews.sql"),
    },
    Migration {
        version: 61,
        sql: include_str!("../migrations/061_identity_invariants.sql"),
    },
    Migration {
        version: 62,
    ...
    Migration {
        version: 65,
        sql: include_str!("../migrations/065_gate_overrides.sql"),
    },
    Migration {
        version: 66,
        sql: include_str!("../migrations/066_autonomy_measurement.sql"),
    },
    Migration {
        version: 68,
        sql: include_str!("../migrations/068_admission_quality.sql"),
    },
    Migration {
        version: 69,
        sql: include_str!("../migrations/069_gate_verdicts.sql"),
    },
    Migration {
        version: 70,
        sql: include_str!("../migrations/070_retained_detail.sql"),
    },
    Migration {
        version: 71,
        sql: include_str!("../migrations/071_selection_decision_front_matter_hold.sql"),
    },
    Migration {
        version: 72,
        sql: include_str!("../migrations/072_selection_decision_foreign_state.sql"),
    },
];
...
mod tests {
    ...
    fn schema_migrations_records_version() {
        ...
        assert_eq!(
            ...
            vec![
                ...
                54, 55, 56, 57, 58, 61, 62, 63, 64, 65, 66, 68, 69, 70, 71, 72
            ]
        );
    }
    ...
    fn version_two_database_upgrades_additively_without_rewriting_summaries() {
        ...
        assert_eq!(db.run_migrations().unwrap(), 58);
    ...
    fn exact_post_backlog_database_upgrades_without_bootstrap_evidence() {
        ...
        assert_eq!(db.run_migrations().unwrap(), 53);
