...
/// Translate the CLI's `Config` subcommand tree into a [`ConfigAction`] and
/// execute it. This is the dispatch-to-domain boundary the `familiar-ai`
/// binary calls from `main()`.
