    ...
    fn make_ctx() -> ToolContext {
        ...
        impl Storage for DummyStorage {
            async fn list_decisions_by_project(
                ...
                _: i64,
                _: usize,
            ) -> Result<Vec<familiar_core::models::Decision>, crate::storage::StorageError>
            {
                Ok(vec![])
            }
            async fn get_project_by_id(
                &self,
                _: i64,
            ) -> Result<Option<familiar_core::models::Project>, crate::storage::StorageError>
            {
                Ok(None)
            }
            ...
            async fn list_active_projects(
                &self,
            ) -> Result<Vec<familiar_core::models::Project>, crate::storage::StorageError>
            {
                Ok(vec![])
            }
            async fn create_session_rollup(
                &self,
                _: &familiar_core::models::NewSessionRollup,
            ) -> Result<familiar_core::models::SessionRollup, crate::storage::StorageError>
            {
            ...
            async fn list_session_rollups_by_project(
                ...
                _: i64,
                _: usize,
            ) -> Result<Vec<familiar_core::models::SessionRollup>, crate::storage::StorageError>
            {
                Ok(vec![])
            }
            async fn create_decision(
                &self,
                _: &familiar_core::models::NewDecision,
            ) -> Result<familiar_core::models::Decision, crate::storage::StorageError> {
                Err(crate::storage::StorageError::Other("dummy".into()))
            }
            async fn get_file_summary(
                ...
                _: i64,
                _: &str,
            ) -> Result<Option<familiar_core::models::FileSummary>, crate::storage::StorageError>
            {
                Ok(None)
            }
            async fn list_file_summaries_under(
                ...
                _: &str,
                _: usize,
            ) -> Result<Vec<familiar_core::models::FileSummary>, crate::storage::StorageError>
            {
                Ok(vec![])
            }
            ...
            async fn create_or_update_file_summary(
                &self,
                _: &familiar_core::models::NewFileSummary,
            ) -> Result<familiar_core::models::FileSummary, crate::storage::StorageError>
            {
                Err(crate::storage::StorageError::Other("dummy".into()))
            }
        }
