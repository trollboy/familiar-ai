...
use chrono::Utc;
use familiar_agent::{CodingAgent, ExecutionRequest, ExecutionResult};
        ...
        let observed = self
            ...
            .execute(
                ExecutionRequest {
                    ...
                    prompt: &prompt,
                    filesystem: familiar_agent::FilesystemPolicy::ReadOnly,
        ...
        let result = self
            ...
            .execute(
                ExecutionRequest {
                    ...
                    prompt: &prompt,
                    filesystem: familiar_agent::FilesystemPolicy::WorkspaceWrite,
                    model: self.assignment.requested_model.as_deref(),
...
mod tests {
    ...
    use familiar_agent::{AgentExecutionError, FilesystemPolicy, IsolationCapability};
